...
<head>
    ...
    <title>ADWKEL11 - DASHBOARD</title>
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php  
                                                 ...
                                                 $sql = "SELECT SUM(s.total) as total_pendapatan from fact_sales s
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php
                                            $sql = "SELECT SUM(order_quantity) as jumlah_penjualan from fact_product";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                        ...
                                        <div class="col mr-2">
                                            ...
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    ...
                                                    <?php
                                                    $sql = "SELECT COUNT(customer_id) as jumlah_cust from fact_sales";
                                                     $query = mysqli_query($mysqli,$sql);
                                                        while($row2=mysqli_fetch_array($query)){
