                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Jumlah Produk Pada Lokasi "Tool Crib" Tahun 2003</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                            <?php  
                                            $sql = "SELECT COUNT(p.transc_id) as jml_loc1 FROM fact_product p
                                                    JOIN location l ON p.location_id=l.location_id
                                                    JOIN time t ON p.time_id=t.time_id 
                                                    WHERE l.location_id = '1' and t.year='2003'";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sql = "SELECT COUNT(p.transc_id) as jml_loc1 FROM fact_product p
                                                    JOIN location l ON p.location_id=l.location_id
                                                    JOIN time t ON p.time_id=t.time_id 
                                                    WHERE l.location_id = 10 OR t.year=1998";
                                            $query = mysqli_query($mysqli,$sql);
                                                 while($row2=mysqli_fetch_array($query)){
                                                    echo number_format($row2['jml_loc1'],0,".",",");
                                                 }
                                    ...
                                    <div class="chart-area-store">
                                        ...
                                        <?php
                                            ...
                                            $kategori = mysqli_query($mysqli,"SELECT DISTINCT(location_name), COUNT(fp.product_id) as total 
                                                    FROM fact_product fp JOIN location f ON fp.location_id = f.location_id 
